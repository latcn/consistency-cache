...
class TwoLevelHotKeyDetectorTest {
	...
	@BeforeEach
	void setUp() {
		detector = TwoLevelHotKeyDetector.Builder.forHighQps().hotKeyThreshold(100).promotionThreshold(70).build();
	}
	...
	void testInvalidThresholds() {
		assertThrows(CacheException.class,
				() -> TwoLevelHotKeyDetector.Builder.forHighQps().hotKeyThreshold(100).promotionThreshold(100).build());

		assertThrows(CacheException.class,
				() -> TwoLevelHotKeyDetector.Builder.forHighQps().hotKeyThreshold(100).promotionThreshold(150).build());

		assertThrows(CacheException.class,
				() -> TwoLevelHotKeyDetector.Builder.forHighQps().hotKeyThreshold(-1).promotionThreshold(50).build());

		assertThrows(CacheException.class,
				() -> TwoLevelHotKeyDetector.Builder.forHighQps().hotKeyThreshold(100).promotionThreshold(-1).build());
	}
	...
	void testInvalidDynamicThresholds() {
		assertThrows(CacheException.class, () -> detector.setPromotionThreshold(150));

		assertThrows(CacheException.class, () -> detector.setPromotionThreshold(-1));

		assertThrows(CacheException.class, () -> detector.setHotKeyThreshold(50));

		assertThrows(CacheException.class, () -> detector.setHotKeyThreshold(-1));
	}
