...
public class DefaultWriteHotspotDetector implements WriteHotspotDetector, AutoCloseable {
    ...
    public DefaultWriteHotspotDetector(int invalidationThreshold, long baseBlacklistTtl,
        ...
        this.hotKeyDetector = TwoLevelHotKeyDetector.Builder.forHighQps()
                ...
                .build();
        log.info("Initialized DefaultWriteHotspotDetector: threshold={}, baseTtl={}, backoff={}",
                invalidationThreshold, baseBlacklistTtl, backoffMultiplier);
    }
