...
import io.github.latcn.cache.spring.service.TestService;
...
/**
 * Integration tests for HccCacheInterceptor with Spring Test Context Framework Uses real
 * beans from CacheAutoConfiguration with properly mocked RedissonClient
 */
