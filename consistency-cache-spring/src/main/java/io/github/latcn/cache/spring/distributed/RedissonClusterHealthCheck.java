...
public class RedissonClusterHealthCheck {
	...
	public static boolean checkClusterHealth(RedissonClient redissonClient) {
		...
		String clusterInfo = script.eval(RScript.Mode.READ_ONLY, clusterInfoScript, RScript.ReturnType.VALUE,
				Arrays.asList("DUMMY"));
	...
	private static void checkNodes(RScript script, RedissonClient redissonClient) {
		...
		String clusterNodes = script.eval(RScript.Mode.READ_ONLY, clusterNodesScript, RScript.ReturnType.VALUE);
